...
namespace Effie2017.App
{
    ...
    public class EmailTemplate : Csla.BusinessBase<EmailTemplate>
    {
        ...
        public string EmailType
        {
            get
            {
                CanReadProperty("EmailType", true);
                return _EmailType;
            }
            set
            {
                CanWriteProperty("EmailType", true);
                if (value == null) value = string.Empty;
                if (!_EmailType.Equals(value))
                {
                    _EmailType = value;
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            _EmailType = dr.GetString("EmailType"); 
        ...
        private void AddInsertParameters(SqlCommand cm)
        {
            ...
            cm.Parameters.AddWithValue("@EmailType", _EmailType);
