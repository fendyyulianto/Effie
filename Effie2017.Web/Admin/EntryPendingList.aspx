<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EntryPendingList.aspx.cs" Inherits="Admin_EntryPendingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadTabStrip runat="server" ID="rtabEntry" CssClass="tabledata" MultiPageID="RadMultiPage1" SelectedIndex="0"
        ...
        <Tabs>
            ...
            <telerik:RadTab Text="Draft Entries" Width="150px" Value="DFT" />
            <telerik:RadTab Text="Ready Entries" Width="150px" Value="RDY" />
        </Tabs>
    </telerik:RadTabStrip>
    ...
    <br />
          ...
          <telerik:RadGrid ID="radGridEntry" runat="server" Skin="Windows7" PageSize="50"
            ...
            <Columns>
                <telerik:GridTemplateColumn  UniqueName="SelectALL" ItemStyle-Width="90px">
                    <HeaderTemplate>
                        <center>
                            All<br />
                ...
                <telerik:GridBoundColumn DataField="DateCreated" HeaderText="Date" DataFormatString="{0:dd/MM/yy H:mm}" ItemStyle-Width="60px"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Campaign" HeaderText="Title" ItemStyle-Width="305px"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Client" HeaderText="Client" ItemStyle-Width="245px"></telerik:GridBoundColumn>
                
                <telerik:GridBoundColumn DataField="CategoryMarket" HeaderText="Category" ItemStyle-Width="100px"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Status" HeaderText="Status" ItemStyle-Width="80px"></telerik:GridBoundColumn>
                <telerik:GridTemplateColumn HeaderText="Prepared By" ItemStyle-Width="80px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnBuSubmittedBy" runat="server" Text="View" CssClass="tblLinkBlack" CommandName="User"></asp:LinkButton>
                        <a href="#" class="tooltip"><img src="../images/icon-info.png" width="15" height="15" /><asp:Label ID="lblSubmittedDetails" runat="server" /></a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                  <telerik:GridBoundColumn DataField="Firstname" HeaderText="First Name" ItemStyle-Width="100px" AllowSorting="true">
                </telerik:GridBoundColumn>
                 <telerik:GridBoundColumn DataField="Lastname" HeaderText="Last Name" ItemStyle-Width="100px" AllowSorting="true">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="DateReminder" HeaderText="Date Reminder" ItemStyle-Width="60px"  DataFormatString="{0:dd/MM/yy H:mm}" ></telerik:GridBoundColumn>
                ...
                <telerik:GridTemplateColumn HeaderText="Actions" HeaderStyle-CssClass="darkGrey" ItemStyle-Width="200px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnView" runat="server" Text="View Entry" CssClass="tblLinkBlack" CommandName="View"></asp:LinkButton>&nbsp;
                        <asp:HyperLink ID="hlkEmailHistory" runat="server" Text="Email History" CssClass="tblLinkBlack" Target="_blank"></asp:HyperLink><br />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>                
                <%--<telerik:GridTemplateColumn HeaderText="" HeaderStyle-CssClass="darkGrey" HeaderStyle-Width="50px">
                    <ItemTemplate>
                        <asp:CheckBox ID="chkbox" runat="server" Visible="false" />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>--%>
