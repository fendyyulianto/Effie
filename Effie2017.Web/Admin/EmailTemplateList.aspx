...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmailTemplateList.aspx.cs"
    Inherits="Admin_EmailTemplateList" MasterPageFile="~/Admin/MasterPageAdmin.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-left: 86%;">
        <input style="display:none;" name="newJury" type="submit" id="newJury" value="Add New Template" onclick="window.location.href = './EmailTemplate.aspx'; return false;" /></div>
    <div class="errorDiv">
        ...
        <MasterTableView TableLayout="Auto">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="No" ItemStyle-Width="30px">
                 ...
                 <telerik:GridTemplateColumn  HeaderText="Template Name" ItemStyle-Width="200px" Visible="false">
                 <ItemTemplate>
                 <asp:Label runat="server" ID="lblTempalteName"></asp:Label>
                 </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridBoundColumn DataField="Title" SortExpression="Title" HeaderText="Template Name">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Subject" SortExpression="Subject" HeaderText="Subject Header">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridTemplateColumn HeaderText="Actions" HeaderStyle-CssClass="darkGrey"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="lnkBtnDelete" runat="server" Text="Delete" CssClass="tblLinkBlack"
                            OnClientClick="return confirm('Are you sure you want to delete ?')" CommandName="delete"></asp:LinkButton>&nbsp;
