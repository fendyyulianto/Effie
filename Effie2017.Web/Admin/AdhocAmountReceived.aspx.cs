...
public partial class Admin_AdhocAmountReceived : System.Web.UI.Page
{
    string pgId;
    ...
    {
        AdhocInvoiceAmountReceivedList list = AdhocInvoiceAmountReceivedList.GetAdhocInvoiceAmountReceivedList(new Guid(pgId));        
