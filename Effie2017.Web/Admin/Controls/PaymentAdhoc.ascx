<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentAdhoc.ascx.cs"
    Inherits="Admin_Controls_PaymentAdhoc" %>
    ...
    <telerik:RadGrid ID="radGridEntry" runat="server" Skin="" MasterTableView-CssClass="tabledata"
        ...
        <MasterTableView TableLayout="Auto">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="Entry ID" ItemStyle-Width="70px">
                  <ItemTemplate>
                        <asp:Label runat="server" ID="lblSerial"></asp:Label>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn HeaderText="Description" ItemStyle-Width="290px">
                    <ItemTemplate>
