<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentGala.ascx.cs" Inherits="Admin_Controls_PaymentGala" %>


<asp:HiddenField ID="hldOrderId" runat="server" />
...
<div style="float: left; width: 660px; margin-right: 20px">
        ...
        <div style="text-align:right"><span>Invoice: </span><asp:Label ID="lblInvoice" runat="server"></asp:Label></div>
        ...
        <MasterTableView TableLayout="Auto"><Columns>
            ...
            <telerik:GridBoundColumn DataField="Client" HeaderText="Client" ItemStyle-Width="290px"></telerik:GridBoundColumn>
...
<!--
        <tr>
            ...
            <td style="padding-bottom: 10px">
                <asp:Label ID="lblPrevReceived" runat="server" />&nbsp;&nbsp;<asp:HyperLink ID="lnkAmountReceived" runat="server" Text="View History" />
            </td>
        </tr>
        <tr>
            <td style="padding-bottom: 10px; width:60%;">
            ...
            <td style="padding-bottom: 10px">
                <asp:TextBox ID="txtAmountRecieved" runat="server" MaxLength="10"></asp:TextBox>
            </td>
        </tr>
-->
        <tr>
        ...
        <tr>
            <td style="padding-bottom: 10p; width:60%;x">
                Remarks:
            </td>
            <td style="padding-bottom: 10px">
