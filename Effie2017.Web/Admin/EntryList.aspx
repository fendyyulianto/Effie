...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadGrid ID="radGridEntry" runat="server" Skin="Windows7" AutoGenerateColumns="false" OnSortCommand="radGridEntry_SortCommand"
        AllowPaging="true" AllowSorting="true" OnItemDataBound="radGridEntry_ItemDataBound" PageSize="<%# PageSizeDefault %>"
        ...
        <MasterTableView AllowCustomSorting="true">
            <Columns>
                <telerik:GridTemplateColumn UniqueName="SelectALL" HeaderText="" ItemStyle-Width="20px">
                    <HeaderTemplate>
                        <center>
                            All<br />
                ...
                <telerik:GridTemplateColumn HeaderText="Invoice" ItemStyle-Width="70px" SortExpression="Invoice">
                    <ItemTemplate>
                ...
                <telerik:GridTemplateColumn HeaderText="Actions" HeaderStyle-CssClass="darkGrey"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="lnkBtnUpdatePayment" runat="server" Text="Update Payment" CssClass="tblLinkBlack"
                            CommandName="Payment"></asp:LinkButton><br />
                        <asp:HyperLink ID="hlkEmailHistory" runat="server" Text="Email History" CssClass="tblLinkBlack"
                            Target="_blank"></asp:HyperLink><br />
                        <asp:LinkButton ID="lbkAdhocInvoice" runat="server" Text="AH Invoice" CssClass="tblLinkBlack"
                            CommandName="adhoc"></asp:LinkButton>
    ...
    <asp:Button ID="btnExport2" runat="server" Text="Export Summary" OnClick="btnExport2_Click" />&nbsp;
    <asp:Button ID="btnReport" runat="server" Text="Assignment Report" OnClick="btnReport_Click" />&nbsp;
    <asp:Button ID="btnEmailReminder" runat="server" Text="Send Email" OnClick="btnEmailReminder_Click" />&nbsp;
    <asp:Button ID="btnAssignToST" runat="server" Text="Assign User" OnClick="btnAssignToST_Click" Visible="false"/>
