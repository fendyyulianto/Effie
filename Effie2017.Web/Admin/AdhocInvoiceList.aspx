<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdhocInvoiceList.aspx.cs"
    Inherits="Admin_AdhocInvoiceList" MasterPageFile="~/Admin/MasterPageAdmin.master" %>

<%@ Register Src="~/Admin/Controls/PaymentAdhoc.ascx" TagName="Payment" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadGrid ID="radGridEntry" runat="server" Skin="Windows7" AutoGenerateColumns="false"
        ...
        <MasterTableView AllowCustomSorting="true">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DateCreated" HeaderText="Request Date" DataFormatString="{0:dd/MM/yy H:mm}"
                    SortExpression="RequestDate" ItemStyle-Width="60px">
                </telerik:GridBoundColumn>
                
                <telerik:GridBoundColumn DataField="InvoiceDate" HeaderText="Invoice Date"
                    SortExpression="InvoiceDate" ItemStyle-Width="60px">
                </telerik:GridBoundColumn>
                <telerik:GridTemplateColumn HeaderText="Invoice No" ItemStyle-Width="80px" SortExpression="Invoice">
                    <ItemTemplate>
                        <asp:Label ID="lblInvoice" runat="server" Text="" CssClass="tblLinkBlack" />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                ...
                <telerik:GridBoundColumn DataField="PayStatus" HeaderText="Status" SortExpression="PayStatus">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="DateReminder" HeaderText="Date Reminder" ItemStyle-Width="60px"
                    SortExpression="DateReminder"  DataFormatString="{0:dd/MM/yy H:mm}" >
                </telerik:GridBoundColumn>
                ...
                <telerik:GridTemplateColumn HeaderText="Actions" HeaderStyle-CssClass="darkGrey"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:HyperLink ID="hlkEmailHistory" runat="server" Text="Email History" CssClass="tblLinkBlack" Target="_blank"></asp:HyperLink>&nbsp;
                         <asp:LinkButton ID="lnkBtnDelete" runat="server" Text="Delete" CssClass="tblLinkBlack" CommandName="DeleteItem" Visible="false" OnClientClick="return ConfirmDelete();"></asp:LinkButton>&nbsp;
                         <%--<asp:LinkButton ID="lnkBtnEmailHistory" runat="server" Text="Email History" CssClass="tblLinkBlack"
                            CommandName="EmailHistory"></asp:LinkButton>--%>&nbsp;
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
            </Columns>
        </MasterTableView>
    ...
    <asp:Button ID="btnEmailReminder" runat="server" Text="Send Email" OnClick="btnEmailReminder_Click" />&nbsp;
     <asp:Button ID="btnDeleteitems" runat="server" Text="Delete" OnClick="btnDeleteitems_Click" OnClientClick="return confirm('Are you sure to continue ?');" />
