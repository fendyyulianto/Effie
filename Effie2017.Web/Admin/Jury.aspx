<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminJury.master"
    AutoEventWireup="true" CodeFile="Jury.aspx.cs" Inherits="Admin_Jury" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript">
        ...
        function ShowHideCompanyType() {
            var dropDownListItems = document.getElementById("<%=ddlCompanyType.ClientID%>");
            var selectedValue = dropDownListItems.options[dropDownListItems.selectedIndex].value;
            var panelOthers = document.getElementById("<%=phCompanyTypeOther.ClientID%>");

            var ddlNetwork = document.getElementById("<%=ddlNetwork.ClientID%>");
            var panelNetworkOthers = document.getElementById("<%=phNetworkOther.ClientID%>");
            var ddlHoldingCompany = document.getElementById("<%=ddlHoldingCompany.ClientID%>");
            var panelHoldingOthers = document.getElementById("<%=phHoldingCompanyOther.ClientID%>");

            if (selectedValue == "Client") {
                panelOthers.style.display = "none";
                ddlNetwork.disabled = true;
                ddlHoldingCompany.disabled = true;
                ddlNetwork.value = '';
                ddlHoldingCompany.value = '';
                panelNetworkOthers.style.display = "none";
                panelHoldingOthers.style.display = "none";
            }
            else if (selectedValue == "Others") {
                panelOthers.style.display = "inline";
                ddlNetwork.disabled = false;
                ddlHoldingCompany.disabled = false;
            }
            else {
                panelOthers.style.display = "none";
                ddlNetwork.disabled = false;
        ...
        function ShowHideNetwork() {
            var dropDownListItems = document.getElementById("<%=ddlNetwork.ClientID%>");
            var selectedValue = dropDownListItems.options[dropDownListItems.selectedIndex].value;
            var panelOthers = document.getElementById("<%=phNetworkOther.ClientID%>");
        ...
        function ShowHideHolding() {
            var dropDownListItems = document.getElementById("<%=ddlHoldingCompany.ClientID%>");
            var selectedValue = dropDownListItems.options[dropDownListItems.selectedIndex].value;
            var panelOthers = document.getElementById("<%=phHoldingCompanyOther.ClientID%>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div style="width: 100%; text-align: right;">
            <table width="800px" border="0" cellspacing="0" cellpadding="0" style="float: right;">
                <!--
                    ...
                    -->
                <tr id="phRoundRound1" runat="server">
                    <td style="width: 70%">
                        Round 1 Panel
                    </td>
                    <td style="width: 30%">
                ...
                <tr id="phRoundRound1_" runat="server">
                    <td>
                        &nbsp;
                    </td>
                </tr>
                <tr id="phRoundRound2" runat="server">
                    <td style="width: 70%">
                        Round 2 Panel
                    </td>
                    <td style="width: 30%">
                ...
                <tr  id="phRoundRound2_" runat="server">
                    <td>
                        &nbsp;
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding-bottom: 10px">
                        <asp:Panel runat="server" ID="pnlPassword">
                            <asp:Label ID="lbPassword" runat="server" Text="Auto generated upon creation" />&nbsp;&nbsp;<asp:LinkButton
                                runat="server" ID="lnkChangePassword" Text="Change Password" OnClick="lnkChangePassword_Click"
                                Visible="false"></asp:LinkButton>&nbsp;&nbsp;<asp:Label runat="server" ID="lblErrorPwd"
                                    ForeColor="Red" Visible="false"></asp:Label>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="pnlChangePassword" Visible="false">
                            <asp:TextBox runat="server" ID="txtPassword" MaxLength="20"></asp:TextBox>&nbsp;&nbsp;
                            <asp:LinkButton runat="server" ID="lnkPasswordSubmit" Text="Update Password" OnClick="lnkPasswordSubmit_Click"></asp:LinkButton>&nbsp;&nbsp;
                            <asp:LinkButton runat="server" ID="lnkCancelPassword" Text="Cancel" OnClick="lnkCancelPassword_Click"></asp:LinkButton>
                        </asp:Panel>
                    </td>
                </tr>
                <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-bottom: 10px">
                        <asp:DropDownList ID="ddlCompanyType" Style="width: 234px" runat="server" onchange="ShowHideCompanyType()">
                        ...
                        <asp:Panel ID="phCompanyTypeOther" Style="display: none;" runat="server">
                            Other:
                            <asp:TextBox ID="txtCompanyTypeOther" runat="server" MaxLength="100"></asp:TextBox></asp:Panel>
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 10px">
                    ...
                    <td style="padding-bottom: 10px">
                        <asp:DropDownList ID="ddlNetwork" Style="width: 234px" runat="server" onchange="ShowHideNetwork()">
                        </asp:DropDownList>
                        <asp:Panel ID="phNetworkOther" runat="server" Style="display: none;">
                            Others:
                            <asp:TextBox ID="txtNetworkOther" runat="server" MaxLength="100"></asp:TextBox></asp:Panel>
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 10px">
                    ...
                    <td style="padding-bottom: 10px">
                        <asp:DropDownList ID="ddlHoldingCompany" Style="width: 234px" runat="server" onchange="ShowHideHolding()">
                            <asp:ListItem Text="Select" Value="" />
                        ...
                        <asp:Panel ID="phHoldingCompanyOther" runat="server" Style="display: none;">
                            Others:
                            <asp:TextBox ID="txtHoldingCompanyOther" runat="server" MaxLength="100" /></asp:Panel>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="leftContainer" style="width: 900px">
        ...
        <telerik:RadGrid ID="radCompanyList" runat="server" OnItemDataBound="radCompanyList_ItemDataBound"
            OnItemCommand="radCompanyList_ItemCommand" Skin="Windows7" AutoGenerateColumns="false"
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-bottom: 10px" colspan="2">
                        ...
                        <asp:PlaceHolder ID="phSkillsCompanyOther" runat="server" Visible="true">
                               Others:
                              <asp:TextBox ID="txtSkillsOthers" runat="server" TextMode="MultiLine"  style=" height: 80px; "/>
                        </asp:PlaceHolder>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-bottom: 10px; display:none;">
                        <asp:Repeater runat="server" ID="rptEffieExp" OnItemDataBound="rptEffieExp_OnItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:CheckBox runat="server" ID="chkYear" />
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtYearRemarks" placeholder="Enter Remarks" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <table class="TableCustom" border="1">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                         <asp:TextBox runat="server" ID="txtYearJuryRemarks" placeholder="Enter Remarks" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                ...
                <tr>
                    <td colspan="2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lbJuryRemarks" runat="server" />
                                </td>
                            </tr>
                            <asp:PlaceHolder ID="phJuryRemarksEdit" runat="server">
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnJurySubmitRemarks" runat="server" Text="Submit Remarks" OnClick="btnJurySubmitRemarks_Click" />
                                    </td>
                                </tr>
                            </asp:PlaceHolder>
                        </table>
