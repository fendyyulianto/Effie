<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JuryEmailSentHistory.aspx.cs"
    Inherits="Admin_JuryEmailSentHistory" %>
    ...
    <telerik:RadGrid ID="radGridTemplateHistory" runat="server" Skin="" AutoGenerateColumns="false"
        ...
        <MasterTableView TableLayout="Fixed">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="Judge Id" ItemStyle-Width="70px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnJuryId" runat="server" CommandName="ViewJury"></asp:LinkButton><br />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn HeaderText="Judge Name" ItemStyle-Width="150px">
                    <ItemTemplate>
