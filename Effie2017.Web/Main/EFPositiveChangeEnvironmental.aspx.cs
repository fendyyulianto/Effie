...
public partial class Main_EFPositiveChangeEnvironmental : System.Web.UI.Page
{
    #region Global Variable
    Entry entry = null;
    List<Data.CountriesList> CTPList = new List<Data.CountriesList>();
    ...
    string  CurrentCategory = Data.DocumentCategories.PositiveChangeEnvironmental.ToString();
    ...
    protected void initJavascript()
    {
        ...
        textBoxKeyup.Add(new TextBoxKeyup { textbox = txtStrategicChallengeObjectivesE, LimitText = 150, isLimitActive = true });
        ...
        textBoxKeyup.Add(new TextBoxKeyup { textbox = txtExplainWorkedA2, LimitText = 100, isLimitActive = true });
        ...
        textBoxKeyup.Add(new TextBoxKeyup { textbox = txtStrategicChallengeObjectivesF, LimitText = 0, isLimitActive = false });
        ...
        if (entryForm != null)
        {
            ...
            if (ELOMG.Count() != 0)
            {
                for (int i = 0; i < ELOMG.Length; i++)
                {
                    ...
                    if (Datas[0] == "998")
                    {
                        cbOtherOtherMarket.Checked = (Datas[1] == "True") ? true : false;
                    }
                    else if (Datas[0] == "999")
                    {
                        txtOtherOtherMarket.Text = Datas[1];
                    }
                    else
                    {
                        try
    ...
    protected void PopulateHeaderForm()
    {
        if (entry != null)
        {
            ...
            {
                txtOtherOtherMarket.Attributes.Add("class", "TextCtmOther");
                cbOtherOtherMarket.Attributes.Add("class", "Cusinput");
    ...
    private void PopulateForm()
    {
        ...
        if (entry != null)
        {
            ...
            //YearPrior.Items.Clear();

            //ddlCurrentYear.Items.Add(new ListItem("Select Current Year", ""));
            //YearPrior.Items.Add(new ListItem("Select Year Prior", ""));

            //for (int i = 2014; i <= 2018;i++)
            //{
            //    ddlCurrentYear.Items.Add(i.ToString());
            //    YearPrior.Items.Add(i.ToString());
            //}
        ...
        if (entryForm != null)
        {
            ...
            if (entryForm.ExplainWorked != "" && entryForm.ExplainWorked != null)
            {
                ...
                if (ExplainWorked.Length != 0)
                {
                    try
                    {
                        ...
                        txtExplainWorkedA2.Text = ExplainWorked[1].Replace("  ", "");
                        txtExplainWorkedB.Text = ExplainWorked[2].Replace("  ", "");
                    }
                    catch { }
                }
            }
            ...
            {
                string[] PCE = entryForm.PaidMediaExpendituresCheck.Split(new string[] { Delimiter[0] }, System.StringSplitOptions.RemoveEmptyEntries);
                if (PCE.Length != 0)
                {
                    try
                    {
                        ddlCurrentYear.Text = PCE[0].Replace("  ", "");
                        YearPrior.Text = PCE[1].Replace("  ", "");
                        ddlPaidMediaExpendituresCurrent.SelectedValue = PCE[2].Replace("  ", "");
                        ddlPaidMediaExpendituresPrior.SelectedValue = PCE[3].Replace("  ", "");
                    }
                    catch
                    {
            ...
            if (entryForm.StrategicChallengeObjectives != "" && entryForm.StrategicChallengeObjectives != null)
            {
                ...
                if (StrategicChallengeObjectivesList.Length != 0)
                {
                    try
                    {
	                    ...
	                    txtStrategicChallengeObjectivesF.Text = StrategicChallengeObjectivesList[5].Replace("  ", "");
                    }
                    catch
                    {
    ...
    protected void UploadCharts(string textbox)
    {
        ...
        if (textbox == "txtExplainWorkedA" || textbox == "txtExplainWorkedA2")
        {
    ...
    protected bool ValidationForm()
    {
        ...
        lbError.Text += GeneralFunction.ValidateTextBox("", txtStrategicChallengeObjectivesE, true, "string", "Please answer Question 1E");
        lbError.Text += GeneralFunction.ValidateTextBox("", txtStrategicChallengeObjectivesF, true, "string", "Please provide sourcing for Section 1. Indicate NA if Not Applicable.");
        ...
        lbError.Text += GeneralFunction.ValidateTextBox("", txtExplainWorkedA, true, "string", "Please answer Question 4A(i)");
        lbError.Text += GeneralFunction.ValidateTextBox("", txtExplainWorkedA2, true, "string", "Please answer Question 4A(ii)");
		...
		if (cbOtherOtherMarket.Checked)
        {
            lbError.Text += GeneralFunction.ValidateTextBox("", txtOtherOtherMarket, true, "string", "Please answer the textbox for Question 4B (Other)");
        }
        if (cbOtherCTP1.Checked)
        {
            lbError.Text += GeneralFunction.ValidateTextBox("", txtOtherCTP2, true, "string", "Please answer the textbox for Communications Touchpoints (Other)");
        }
    ...
    protected EntryForm SetEntryFormValue()
    {
        ...
        entryForm.ExplainWorked = txtExplainWorkedA.Text + "  " + Delimiter[0] + "  " + txtExplainWorkedA2.Text + "  " + Delimiter[0] + "  " + txtExplainWorkedB.Text + Delimiter[0];
        ...
        entryForm.StrategicChallengeObjectives = txtStrategicChallengeObjectivesA.Text + "  " + Delimiter[0] + "  " + txtStrategicChallengeObjectivesB.Text + "  " + Delimiter[0] + "  " +
                                                 ...
                                                 txtStrategicChallengeObjectivesE.Text + "  " + Delimiter[0] + "  " + txtStrategicChallengeObjectivesF.Text + "  " + Delimiter[0];
        ...
        string Temp = "";
        {
            foreach (RepeaterItem rpt in rptCTP.Items)
            {
                ...
                else if (hdAttrType.Value == "SingleHeader")
                {
                    cbItem.CssClass = "Cusinput";
                    Title.Font.Bold = true;
                    //Title.Text = "<span  style=\" font-size: 14px; \">" + Title.t + "</span>";
                }
    ...
    protected string GetEOM()
    {
        string TimePerioddb = "";
        {
            ...
            TimePerioddb += "998" + ":" + cbOtherOtherMarket.Checked + Delimiter[0];
            TimePerioddb += "999" + ":" + txtOtherOtherMarket.Text + Delimiter[0];
        }
        return TimePerioddb;
    }
}
