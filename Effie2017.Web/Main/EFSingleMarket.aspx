<%@ Page Title="" Language="C#" MasterPageFile="~/Common/MasterPage.master" AutoEventWireup="true"
    CodeFile="EFSingleMarket.aspx.cs" Inherits="Main_EFSingleMarket" MaintainScrollPositionOnPostback="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <span style="font-weight:bold"> Market and Time Period of your Case:</span>
        	<br><br>
        <table class="tabledata" rules="all" style="font-size: 14px;">
            ...
            <tr>
                <td style="padding-bottom: 10px; width: 200px;" colspan="3">
                    <span style="font-weight:bold"> Total number of Market(s) in which the case ran or is currently running:</span>
                </td>
                <td style="padding-bottom: 10px; width: 200px;">
        ...
        <span style="font-weight: bold">Why is this a best in class example of marketing effectiveness and worthy of an award in this specific Effie entry category? 
		...
		<span id="txtStrategicChallengeObjectivesC_Edit">
          <input type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtStrategicChallengeObjectivesC'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 3 charts/graphs)
        </span>
        ...
        <span style="font-weight: bold">1D. What were your measurable objectives? What were the Key Performance Indicators (KPIs) against your objectives?  
            Provide specific numbers/percentages for each objective and prior year benchmarks wherever possible. <br/><br/>
            Effie is open to all types of objectives: Business, Behavioral, Perceptual/Attitudinal. It is the entrant’s responsibility to 
            explain why their particular objectives are important to the business and challenging to achieve. 
	    <br/><br/>Effie Tips: </span><br/> <br/>
        <ul class="IconList">
		...
		<span id="txtStrategicChallengeObjectivesD_Edit">
          <input type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtStrategicChallengeObjectivesD'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 3 charts/graphs)
        </span>
        ...
        <br/>
        <span style="font-weight: bold;margin-left: 4px;">2A. State the insight that led to your big idea, and explain how your observations led you to your insight.</span>
		...
		<span style="font-weight: bold"><br/><br/>Effie Tips: </span>
		...
		<span id="txtIdeasA_Edit">
          <input type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtIdeasA'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 3 charts/graphs)
        </span>
        ...
        <br/><br/>Effie Tips: </span><br/><br/>
        <ul class="IconList">
          <li> The big idea is <u>not the execution or tagline.</u> It is the core idea that drove your effort which led to the breakthrough results.</li>
        </ul>
        <br/>
        <asp:TextBox CssClass="TextCtm" ID="txtIdeasB" runat="server" TextMode="MultiLine" placeholder="Provide a one-sentence answer."></asp:TextBox>
        <br/>
        <p style="text-align: right; font-size: 12px">
        ...
        <br/>
        <span style="font-weight: bold">3. How did you bring the idea to life?  Explain your idea and your overall communications strategy. as borne from the insights and strategic challenge described earlier.
        <br/><br/>
           Elaborate on your communications strategy, including the rationale behind your key channel choices. Your explanation below must include which specific channels were considered integral to your media strategy and why.
        <br/><br/>Effie Tips: </span><br/><br/>
        <ul class="IconList">
		...
		<span id="txtAnything_Edit">
          <input type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtAnything'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 3 charts/graphs)
        </span>
        ...
        <br/>
        <%--<p style="text-align: right; font-size: 12px">
            Remaining word count : <font color="red"><span id="show_remaining_words<%= txtBringingIdea.ClientID %>">475 </span></font>
            (max 475)
        </p>--%><br>
        ...
        <br/><br/>Explain, with <u>category</u> and <u>prior year</u> context, why these results are significant for the brand’s business.  
            Results must relate to your specific audience, objectives, and KPIs that was described earlier.  Provide a clear time frame for all data shown.  


        <br/><br/>Effie Tips: </span><br/><br/>
        <ul class="IconList">
            <li> 	Tie together the story of how your work drove the results. </li>
            <li>    Entrants are strongly encouraged to re-state their objectives from section 1 along with their corresponding results.</li>
            ...
            <li> 	Charts and graphs are strongly encouraged.</li>
        </ul>
        <p class="efDesc">
           Note: Only results that fall between 1 July 2018 - August 31, 2019 will be evaluated by judges. 
            Dates for all results presented here should be included to prevent confusion. 
            You may include data before your start date for context purposes, but do not include results after 31 August 2019. 
		...
		<span id="txtExplainWorkedA_Edit">
          <input type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtExplainWorkedA'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 5 charts/graphs)
        </span>
        ...
        <span style="font-weight: bold">4B. Marketing communications rarely work in isolation.  Outside of your effort, what else in the marketplace could have affected the results of this case – positive or negative?
         <br /><br /> Select factors from the chart and explain the influence of these factors in the space provided.  We recognise that attribution can be difficult; however, we’re inviting you to provide the broader picture here in making the case for your effectiveness.
        ...
        <table class="tabledata" rules="all" border="1" >
            ...
            <tr>
                <td>
                    ...
                    <asp:TextBox CssClass="TextCtmOther" ID="txtOtherSingleMarket" runat="server"></asp:TextBox>
                </td>
            </tr>
        </table>
        </div>
		...
		<span id="txtExplainWorkedB_Edit">
          <input  type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtExplainWorkedB'); return false;" />
        &nbsp;&nbsp;&nbsp;(up to 3 charts/graphs)
        </span>
        ...
        <%--<br/>
        <p style="text-align: right; font-size: 12px">
            Remaining word count : <font color="red"><span id="show_remaining_words<%= txtListAndExplainOtherMarketingText.ClientID %>">90</span></font>
            (max 90)
        </p>--%><br><br>
        
		<span id="txtListAndExplainOtherMarketingText_Edit">
          <input style="display:none" type="submit" value="Upload charts/graphs" onclick="return UploadCharts('txtListAndExplainOtherMarketingText'); return false;" />
        </span>
        <span id="txtListAndExplainOtherMarketingText_View"></span>
		
        <br/>
        
        <div class="HeaderTitle">
            <font size="2" face="Verdana">
                <h2>MEDIA ADDENDUM</h2>
            </font>
        </div>
        <p class="efDesc">
        ...
        <span style="font-weight: bold">
            Budget Elaboration: You are required to provide judges with the context to understand your budget. <br/>
            For example, if your budget has changed significantly, how does this range compare to your competitors'; 
            or, if your paid media expenditures were low and the production/other costs were high, you should elaborate here. 
            <br/><br/>
        ...
        <span style="font-weight: bold">Select all touchpoints used in the effort based on the options provided in the chart.  
            Within your response to Question 3, explain which touchpoints were integral in reaching your audience and why.
		
        <br/><br/>Effie Tips: </span><br/><br/>
        <ul class="IconList">
          <li>On the Creative Materials, you must show at least one complete example of each communication touchpoint that was <u>integral</u> 
              to the effort’s success.  For example, 
              if you mark 30 boxes below and 10 were key to driving the results and indicated as integral in Question 3, 
              those 10 must be featured in the Creative Materials.</li>
        </ul>
        <br/>
